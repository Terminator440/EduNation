-- Run in Supabase SQL Editor: invitation personal data + profiles RLS.
-- Idempotent where possible.

-- ========== 1. INVITATIONS: first_name, last_name, student_number, email, phone ==========
...
-- ========== 2. create_invitation: accept and save personal data ==========
...
-- ========== 3. claim_invitation: return personal data for signup ==========
...
-- ========== 4. PROFILES RLS: Diriginte edit students/parents, Director edit teachers ==========
-- Requires profile_role_rank from 20260213110000_profiles_update_rls.sql
