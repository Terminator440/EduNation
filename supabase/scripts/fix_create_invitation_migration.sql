-- =============================================================================
-- Fix create_invitation RPC and invitations schema
-- Run this in Supabase SQL Editor to fix "Could not find the function create_invitation"
-- Idempotent: safe to run multiple times.
-- =============================================================================

-- 1. Add columns to invitations table (if missing)
...
-- 2. Add contact_email and contact_phone to students (if missing) - for Reports/Profiles
ALTER TABLE public.students
  ADD COLUMN IF NOT EXISTS contact_email TEXT,
  ADD COLUMN IF NOT EXISTS contact_phone TEXT;

-- 3. Drop ALL overloads of create_invitation so we can create the new one
DO $$
DECLARE
  r RECORD;
BEGIN
...
-- 4. Create create_invitation with full parameter list including p_first_name, p_last_name, p_student_number
